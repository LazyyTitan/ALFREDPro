...
public class PeopleScreen extends AppCompatActivity {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_people:
                    ...
                    intent = new Intent(PeopleScreen.this, PeopleScreen.class);
                    startActivity(intent);
                    setContentView(R.layout.activity_people);
                    return true;
                case R.id.navigation_home:
                    mTextMessage.setText(R.string.title_home);
                    intent = new Intent(PeopleScreen.this, HomeScreen.class);
                    startActivity(intent);
                    setContentView(R.layout.activity_home);
                    return true;
                case R.id.navigation_users:
                    mTextMessage.setText(R.string.title_users);
                    intent = new Intent(PeopleScreen.this, MainActivity.class);
                    startActivity(intent);
                    setContentView(R.layout.activity_main);
                    return true;
                ...
                case R.id.navigation_plates:
                    ...
                    intent = new Intent(PeopleScreen.this, PlatesScreen.class);
                    startActivity(intent);
                    return true;
            }
            return false;
